...
if($_POST){	
	$endpoint = "http://localhost:9000/dashboards/".$dashboardId."/addUser";	
	$dashboardUsers = $_POST;

	foreach($dashboardUsers as $k => $v){
	...
	header('Location:create_dashboard_step2.php?id='.$dashboardId);	
}
...
<html lang="es">
  ...
  <body>
	...
	<form method="POST">
		...
		<br><br><br>        
		<p>
		  <input name="submit_dashboard1" type="submit" class="btn btn-lg btn-primary" role="button" value="Siguiente">
		</p>
	      </div>
	</form>
    </div>
