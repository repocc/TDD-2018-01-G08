...
$endpoint = "http://localhost:9000/dashboards/$idDashboard/rules/all";
$result = curlGet($endpoint);

$rulesHTML = getRulesHTML($result);
?>
<!DOCTYPE html>
<html lang="es">
  <head>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div style="min-height:350px;" class="jumbotron">
        <h3>Contadores</h3><br><br>
	<button type="button" class="btn btn-group-sm btn-warning" onclick="window.location='dashboard_detail.php?id=<?=$idDashboard?>&name=<?=$dashboardName?>'">Volver</button><br><br>	
	<?=$rulesHTML;?>	
      </div>
    </div>
  </body>
