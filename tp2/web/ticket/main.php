...
<html lang="es">
  ...
  <body>
	...
	<p>Comenza con un nuevo proyecto, para eso presiona el botón de Crear Proyecto y segui atentamente los pasos.</p><br>        
	<p>
          <a class="btn btn-lg btn-primary" href="create_project.php" role="button">Crear Proyecto</a>
        </p>
      </div>
    </div>
  </body>
