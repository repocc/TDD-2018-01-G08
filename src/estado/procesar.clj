...
(ns estado.procesar
  (:require
    [estado.estado :as est] ;obtenerDatosPasados
    [interprete.definiciones :as def] ;ejecutarFuncion
    [interprete.procesamiento :as proc] ;expresionValidaContemplandoPast?, ejecutarFuncionContemplandoPast, expresionValida?
    [tipos.bool-funciones :refer :all] ;ejecutarFuncion
    [tipos.number-funciones :refer :all] ;ejecutarFuncion
    [tipos.string-funciones :refer :all] ;ejecutarFuncion
    :reload-all))
