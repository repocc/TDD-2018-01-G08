(ns com.ar.fiuba.tdd.clojure.tipos.funciones-implementacion
  (require  [com.ar.fiuba.tdd.clojure.interprete.definiciones :refer :all])
  (require  [com.ar.fiuba.tdd.clojure.tipos.number-definicion-funciones :refer :all])
  (require  [com.ar.fiuba.tdd.clojure.tipos.string-definicion-funciones :refer :all])
  (require  [com.ar.fiuba.tdd.clojure.tipos.bool-definicion-funciones :refer :all]))
